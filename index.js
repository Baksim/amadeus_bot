...
client.on('message', message => {
    ...
    if(message.content.toLowerCase().includes("амадей, как дела" || "амадей, как настроение"))
    {
        var text = [
    ...
    if (message.content.toLowerCase() == "цитата алехандро" || "амадей, процитируй алехандро" || "процитируй алехандро")
    {    
