...
client.on('message', message => {
    ...
    {
        message.channel.send("В мой функционал входят:\n• Возможность отпралять в чат смешные картинки по ключеввм словам,\n• Возможность включать музыку (пока нет),\n• Возможность предоставить пользователю базу данных с номерами телефонов и другой личной информацией его одноклассников (тоже нет),\n• Возможность замутить неугодных или раздражающих пользователей войс-чата (и это нет),\n• Могу показать погоду (а вот это правда)");
    }
