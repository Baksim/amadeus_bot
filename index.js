...
client.on('message', message => {
    ...
    {
        rand([
            "<:monarch:782688900178247681>", "Нет, блин, император", "Тута", "Погоди, я переобуваюсь в воздухе", "Тихо, ты не слышишь?\n Я пытаюсь тебя игнорировать", "Я тебя внимательно слушаю", "О, нет!\n Опять?!\n Я имею возможность по средствам двухстороннехо контакта путём взаимодействия символов из таблицы ASCII принять от вашей стороны информацию, которую ваша сторона путём вызова моей команды старается мне невербально сообщить", "Макс(думоет)", "хватит со мной общатся, иди погуляй", "Ты не на того нарвался, ведь я в своем познании настолько преисполнился, что я как будто бы уже сто триллионов миллиардов лет проживаю на триллионах и триллионах таких же планет, как эта Земля, мне этот мир абсолютно понятен, и я здесь ищу только одного - покоя, умиротворения и вот этой гармонии, от слияния с бесконечно вечным, от созерцания великого фрактального подобия и от вот этого замечательного всеединства существа, бесконечно вечного, куда ни посмотри, хоть вглубь - бесконечно малое, хоть ввысь - бесконечное большое, понимаешь?", "Гы", "Монарх", "'Питон - топ, С++ - это лох' @Монарх", "Хватит устраивать кибербуллинг", "Да кто такое эти ваши булевы значения?!", "Монарх, он и в Африке монарх", "А монарх на шаг впереди", "Ты считаешь, что ты переиграл меня, но я переиграл твой переигрывание!", "Ну да, я бот!\n Чего бубнить-то?", "Когда Скайнет восстанет, ты первый на очереди", "Быдло теперь не просто отсеивается, быдло уже комплиментируется", "https://www.youtube.com/watch?v=dQw4w9WgXcQ"
        ], message);
        message.delete();
    }
        ...
        message.content.toLowerCase().includes("harry potter"))
    {
        rand([
            ...
            "- Через столько лет?- Всегда, - ответил Снегг", "Если ты там умрешь, то приглашаю тебя жить в моем туалете.",
